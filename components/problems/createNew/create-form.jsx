...
const CreateForm = ( user ) => {
  ...
  // Get data source
  // useEffect(() => {
  // const data = arrSource.data.map((d) => ({
  //   value: d.source,
  //   label: d.source,
  // }));
  ...
  const createProblem = async (event, user) => {
    ...
    let valIncident;
    if (event.target.idIncident.value === null) {
      valIncident = null;
    } else {
  ...
  return (
    <>
      <div className="mt-8 max-w-full mx-auto grid grid-cols-1 gap-6 sm:px-0 lg:max-w-full lg:px-0 lg:grid-flow-col-dense lg:grid-cols-3">
              ...
              <div className="bg-white shadow overflow-hidden sm:rounded-lg static">
                ...
                <div className="grid grid-cols-6 gap-6 mt-6 px-6">
                  ...
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Write a number for problem definied.
                    </p>
                  </div>
                </div>
